...
transcendence:setParameter(CONDITION_PARAM_SUBID, AttrSubId_JeanPierreMelee)
...
local potions = {
	[236] = { health = { 500, 700 }, vocations = { VOCATION.BASE_ID.PALADIN, VOCATION.BASE_ID.KNIGHT, VOCATION.BASE_ID.MONK }, level = 50, flask = 283, description = "Only knights, paladins and monks of level 50 or above may drink this fluid." },
	[237] = { mana = { 230, 370 }, level = 50, flask = 283, description = "Only players of level 50 or above may drink this fluid." },
	[238] = { mana = { 300, 500 }, vocations = { VOCATION.BASE_ID.SORCERER, VOCATION.BASE_ID.DRUID, VOCATION.BASE_ID.PALADIN, VOCATION.BASE_ID.MONK }, level = 80, flask = 284, description = "Only sorcerers, druids, paladins and monks of level 80 or above may drink this fluid." },
	[239] = { health = { 850, 1150 }, vocations = { VOCATION.BASE_ID.KNIGHT }, level = 80, flask = 284, description = "Only knights of level 80 or above may drink this fluid." },
	[266] = { health = { 250, 350 }, flask = 285 },
	[268] = { mana = { 150, 250 }, flask = 285 },
	...
	[7642] = { health = { 500, 700 }, mana = { 200, 400 }, vocations = { VOCATION.BASE_ID.PALADIN, VOCATION.BASE_ID.MONK }, level = 80, flask = 284, description = "Only paladins and monks of level 80 or above may drink this fluid." },
	[7643] = { health = { 1300, 1700 }, vocations = { VOCATION.BASE_ID.KNIGHT }, level = 130, flask = 284, description = "Only knights of level 130 or above may drink this fluid." },
	[7644] = { combat = antidote, flask = 285 },
	[7876] = { health = { 120, 180 }, flask = 285 },
	[23373] = { mana = { 850, 1150 }, vocations = { VOCATION.BASE_ID.SORCERER, VOCATION.BASE_ID.DRUID }, level = 130, flask = 284, description = "Only druids and sorcerers of level 130 or above may drink this fluid." },
	[23374] = { health = { 840, 1160 }, mana = { 500, 700 }, vocations = { VOCATION.BASE_ID.PALADIN, VOCATION.BASE_ID.MONK }, level = 130, flask = 284, description = "Only paladins and monks of level 130 or above may drink this fluid." },
	[23375] = { health = { 1750, 2250 }, vocations = { VOCATION.BASE_ID.KNIGHT }, level = 200, flask = 284, description = "Only knights of level 200 or above may drink this fluid." },
	...
	[49271] = {
		...
		description = "Only monks may drink this potion.",
		text = "You feel more balanced.",
	},
}
