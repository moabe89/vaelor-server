...
-- MySQL
mysqlHost = os.getenv("MYSQL_HOST") or "127.0.0.1"
mysqlUser = os.getenv("MYSQL_USER") or "root"
mysqlPass = os.getenv("MYSQL_PASSWORD") or ""
mysqlDatabase = os.getenv("MYSQL_DATABASE") or "canary"
